...
public class DisciplineDaoImpl extends AbstractCrudDaoImpl<Discipline> implements DisciplineDao {
    ...
    private static final String FIND_BY_ID_QUERY =
            "SELECT discipline.discipline_id, discipline.discipline_name, "
                    ...
                    + "LEFT JOIN teacher ON discipline_teacher.teacher = teacher.teacher_id WHERE discipline_id = ?";
    ...
    private static final String FIND_ALL_PAGED_QUERY =
            "SELECT discipline.discipline_id, discipline.discipline_name, "
                    ...
                    + "FROM discipline "
                    + "LEFT JOIN discipline_teacher ON discipline.discipline_id = discipline_teacher.discipline "
                    + "LEFT JOIN teacher ON discipline_teacher.teacher = teacher.teacher_id ORDER BY discipline_id LIMIT ? OFFSET ?";
    ...
    private static final String FIND_BY_NAME_QUERY = "SELECT discipline.discipline_id, discipline.discipline_name, "
            ...
            + "FROM discipline "
            + "LEFT JOIN discipline_teacher ON discipline.discipline_id = discipline_teacher.discipline "
            + "LEFT JOIN teacher ON discipline_teacher.teacher = teacher.teacher_id WHERE discipline_name = ?";
